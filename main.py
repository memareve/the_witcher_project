...
def game_over():
    ...
    if ans == 'да':
        ...
        print('Жаль, прощай. Я надеялся на твою помощь.')
        exit()
...
def _initial_():
    ...
    if ans == 'да':
        ...
        time.sleep(1)
        print("Я потерялся среди в подземельях краснолюдов (местные карлики) в Новиграде и тебе "
        ...
        if t_p != 0 and s_p == 0:
            ...
            if ans == '1':
                ...
                print('- Буль-буль, тебе в тот люк за моей спиной. Можешь мне не верить, но, клянусь, '
                      'тебе понадобится веревка, чтобы не разбится. Не хочешь купить у меня за 100 оренов?')
                rope()
...
def ask():
    ...
    if ans == 'андрейгеннадьевичминак' or ans == 'андрейминакгеннадьевич' or ans == 'минакандрейгеннадьевич' or \
        ...
        time.sleep(2)
        print(
            '- Можешь мне не верить, но, клянусь, тебе понадобится веревка, чтобы не разбится. Не хочешь купить у меня'
            ' за 100 оренов?')
        rope()
    else:
        game_over()
